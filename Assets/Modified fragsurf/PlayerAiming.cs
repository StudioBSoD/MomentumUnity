...
public class PlayerAiming : MonoBehaviour
{
	...
	private void Update()
	{
		...
		// Input
		float xMovement = InputManager.local.look.x * horizontalSensitivity * sensitivityMultiplier;
		float yMovement = -InputManager.local.look.y * verticalSensitivity  * sensitivityMultiplier;
