    ...
    public class SurfController {
            ...
            switch (_surfer.moveType)
            {
                ...
                else
                {
                    ...
                    */
                    ...
                    float speed = _surfer.moveData.sprinting ? _config.sprintSpeed : _surfer.moveData.walking ? _config.walkSpeed : _config.normalSpeed;
                    if (crouching)
        ...
        public void Crouch (ISurfControllable surfer, MovementConfig config, float deltaTime)
        {
            ...
            */
            ...
            if (/*crouchLerp > 0.9f*/wantsToCrouch && !crouching) {
                ...
                // Uncrouch
                if (canUncrouch && !wantsToCrouch/*crouchLerp <= 0.9f*/)
                {
                    crouching = false;
                    if (_surfer.collider.GetType () == typeof (BoxCollider))
                    {
