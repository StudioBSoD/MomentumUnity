...
namespace Fragsurf.Movement
{
    ...
    {
        public static SurfCharacter local;
        ...
        private SurfController _controller = new();
        ...
        public SurfController controller { get { return _controller; } }
        ...
        private void Awake ()
        {
            if (local != null && local != this) { Destroy(this); return; }
            local = this;
        ...
        {
            _moveData.verticalAxis = InputManager.local.move.y;
            _moveData.horizontalAxis = InputManager.local.move.x;

            _moveData.sprinting = InputManager.local.sprint;
            _moveData.walking = InputManager.local.walk;
            
            _moveData.crouching = InputManager.local.crouch;
            ...
            if (InputManager.local.jumpOnce)
                _moveData.wishJump = true;

            if (!InputManager.local.jump)
